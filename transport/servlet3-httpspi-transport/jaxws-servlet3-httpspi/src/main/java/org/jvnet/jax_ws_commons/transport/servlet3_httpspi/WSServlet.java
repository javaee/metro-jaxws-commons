...
public class WSServlet extends HttpServlet {
     ...
     */
    public List<EndpointAdapter> adapters;
    ...
    public void init(ServletConfig servletConfig) throws ServletException {
        ...
        this.adapters = (List<EndpointAdapter>)context.getAttribute(JAXWS_RI_RUNTIME_INFO);
     ...
     * created by the {@link WSServletContainerInitializer}
     *
